...
const WeatherCard = ({ weatherCities,loading }) => {
  useEffect(() => {
    weatherCard()
  },[])
  useEffect(() => {
    
    switch (weatherCities.weather.summary.title) {
      case "Clear":
          document.getElementById("button-sun").click()
      break;
      case "Clouds":
          document.getElementById("button-clouds").click()
      break;
      case "Snow":
    ...
    <div className="background">
      <div className="container">	
        ...
        <nav style={{display:"none"}}>
          <ul>
            <li><a id="button-snow" className="active" href="#snow"><i className="wi wi-snow"></i></a></li>
            <li><a id="button-clouds" href="#cloudy"><i className="wi wi-strong-wind"></i></a></li>
            <li><a id="button-rain" href="#rainy"><i className="wi wi-rain"></i></a></li>
            <li><a id="button-thunder" href="#thunder"><i className="wi wi-lightning"></i></a></li>
            <li><a id="button-sun" href="#sunny"><i className="wi wi-day-sunny"></i></a></li>
          </ul>
        </nav>
        <div id="card" className="weather">
          ...
          <div className="details">
            <div className="temp">{kelvinToCelcius(weatherCities.weather.temperature.actual)}<span>c</span></div>
            <div className="right">
              <div id="date">{weatherCities ? toDateTime(weatherCities.weather.timestamp) : 'Loading...'}</div>
              <div id="summary"></div>
            </div>
          </div>
        </div>
